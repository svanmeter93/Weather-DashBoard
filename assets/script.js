...
const singleDayDiv = document.getElementById("single-day")
    ...
    .then((data) => {
      ...
      fetch(currentURL)
        ...
        .then((data) => {
          ...
          const singleDayEl = document.createElement("div");
          const singleDayContents = `<p>Current Wind: ${currentWind}</p><br><p>`;
          singleDayEl.innerHTML = singleDayContents;
          singleDayDiv.append(singleDayEl);
        });
...
document.getElementById("search").addEventListener("click",userResult)